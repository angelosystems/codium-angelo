...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/angelosystems/versions/refs/heads/master"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/angelosystems/codium-angelo-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/angelosystems/codium-angelo/releases"
fi
